...
public class ItemTrashCanContainer extends TrashCanContainer {
                ...
                CustomSlot.builder()
                    ...
                    .extractor(amount -> {
                        ...
                        if(extracted == stack.getCount())
                            ...
                            this.object.setDeletedItem(index, stack.copyWithCount(stack.getCount() - extracted));
    ...
    @Override
    public void clicked(int index, int dragType, ContainerInput input, Player player){
        ...
        super.clicked(index, dragType, input, player);
    }
