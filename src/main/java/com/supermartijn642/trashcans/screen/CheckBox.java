...
public class CheckBox extends AbstractButton {
    ...
    public CheckBox(int x, int y, Runnable onPress){
        super(x, y, 17, 17, new StringTextComponent(""));
    ...
    public void func_230431_b_(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks){
        ...
        drawTexture(this.field_230690_l_, this.field_230691_m_ - 3, this.checked ? 0 : 20, (this.field_230693_o_ ? this.field_230692_n_ ? 1 : 0 : 2) * 20);
