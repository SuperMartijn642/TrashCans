...
public class WhitelistButton extends AbstractButtonWidget {
    ...
    public static final Identifier BUTTONS = Identifier.fromNamespaceAndPath("trashcans", "blacklist_button");
    ...
    public void render(WidgetRenderContext context, GuiGraphicsHelper graphics, int mouseX, int mouseY){
        graphics.submitSprite(BUTTONS, this.x, this.y, this.width, this.height, p -> p.uv(this.white ? 0 : 0.5f, (this.active ? this.isFocused() ? 1 : 0 : 2) / 3f, 0.5f, 1 / 3f));
    }
