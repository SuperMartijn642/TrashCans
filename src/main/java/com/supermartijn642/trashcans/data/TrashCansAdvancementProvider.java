...
public class TrashCansAdvancementProvider implements IDataProvider {
    ...
    public void run(DirectoryCache hashCache){
        ...
        Advancement trash_can = Advancement.Builder.advancement()
            ...
            .addCriterion("has_trash_can", InventoryChangeTrigger.Instance.hasItem(TrashCans.item_trash_can))
            .addCriterion("has_trash_can2", InventoryChangeTrigger.Instance.hasItem(TrashCans.liquid_trash_can))
            .addCriterion("has_trash_can3", InventoryChangeTrigger.Instance.hasItem(TrashCans.energy_trash_can))
        ...
        Advancement ultimate_trash_can = Advancement.Builder.advancement()
            ...
            .addCriterion("has_trash_can", InventoryChangeTrigger.Instance.hasItem(TrashCans.ultimate_trash_can))
